  ...
  return (
    <SectionShell id="contact" className="pb-10 lg:pb-16">
      <GlassCard className="p-6 md:p-10">
        <div className="pointer-events-none absolute -right-32 top-0 h-72 w-72 rounded-full bg-emerald-300/12 blur-3xl" />
        <div className="relative">
          <p className="font-mono text-xs font-semibold uppercase tracking-[0.28em] text-cyan-100/65">
            Contact
          </p>
